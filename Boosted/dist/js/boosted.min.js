...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).boosted =
        e(t.Popper));
})(this, function (t) {
  "use strict";
  function e(t) {
  ...
  function x(t, e, i, s) {
    ...
    for (const [o, r] of Object.entries(n))
      o.includes(s) && D(t, e, i, r.callable, r.delegationSelector);
  }
  function M(t) {
    ...
    off(t, e, i, s) {
      ...
      if (void 0 === o) {
        ...
        for (const [i, s] of Object.entries(c)) {
          const n = i.replace(C, "");
          (a && !e.includes(n)) || D(t, l, r, s.callable, s.delegationSelector);
        }
      } else {
  ...
  class H {
    ...
    _mergeConfigObj(t, e) {
      const i = l(e) ? z.getDataAttribute(e, "config") : {};
      return {
        ...this.constructor.Default,
        ...("object" == typeof i ? i : {}),
        ...(l(e) ? z.getDataAttributes(e) : {}),
        ...("object" == typeof t ? t : {}),
      };
    }
  ...
  const lt = ".bs.carousel",
    ...
    kt = ".carousel-item",
    St = Lt + kt,
    $t = ".carousel-control-play-pause",
    Nt = "data-bs-target",
    Ot = "data-bs-play-text",
    It = "data-bs-pause-text",
    Pt = "Play Carousel",
    Dt = "Pause Carousel",
    xt = { ArrowLeft: mt, ArrowRight: ut },
    Mt = {
      interval: 5e3,
      keyboard: !0,
      pause: "hover",
  ...
  class Ft extends W {
    constructor(t, e) {
      super(t, e),
        ...
        (this._playPauseButton = K.findOne(
          `${$t}[${Nt}="#${this._element.id}"]`
        )),
        this._addEventListeners(),
        this._config.ride === Et
          ? this.cycle()
          : this._indicatorsElement && this._element.classList.add(Ct);
    }
    static get Default() {
      return Mt;
    }
        ...
        null !== this._playPauseButton &&
          ...
          this._playPauseButton.getAttribute(Ot)
            ? (this._playPauseButton.setAttribute(
              ...
              (this._playPauseButton.querySelector(
                "span.visually-hidden"
              ).innerHTML = this._playPauseButton.getAttribute(Ot)))
    ...
    cycle() {
      this._indicatorsElement && this._element.classList.remove(Ct),
        null !== this._playPauseButton &&
          ...
          this._playPauseButton.getAttribute(It)
            ? (this._playPauseButton.setAttribute(
              ...
              (this._playPauseButton.querySelector(
                "span.visually-hidden"
              ).innerHTML = this._playPauseButton.getAttribute(It)))
            : (this._playPauseButton.setAttribute("title", Dt),
              (this._playPauseButton.querySelector(
                "span.visually-hidden"
              ).innerHTML = Dt)),
          (this._stayPaused = !1)),
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding
          ? j.one(this._element, gt, () => this.cycle())
          : this.cycle());
    }
    to(t) {
      this._indicatorsElement && this._element.classList.remove(Tt);
      const e = this._getItems();
      if (t > e.length - 1 || t < 0) return;
      if (this._isSliding)
        return void j.one(this._element, gt, () => this.to(t));
    ...
    _addEventListeners() {
      this._config.keyboard && j.on(this._element, ft, (t) => this._keydown(t)),
    ...
    _enableControl(t) {
      "BUTTON" === t.nodeName
        ? (t.disabled = !1)
        : (t.removeAttribute("aria-disabled"), t.removeAttribute("tabindex"));
    }
    _getItemIndex(t) {
    ...
    _setActiveIndicatorElement(t) {
      ...
      const e = K.findOne(Lt, this._indicatorsElement);
    ...
    _updateInterval() {
      ...
      if (
        ...
        this._indicatorsElement && this._config.interval !== Mt.interval)
      ) {
    ...
    _slide(t, e = null) {
      ...
      if (
        ...
        const t = K.findOne(".carousel-control-prev", this._element),
          e = K.findOne(".carousel-control-next", this._element);
    ...
    _getItems() {
      return K.find(kt, this._element);
    }
    _clearInterval() {
      this._interval &&
    ...
    _orderToDirection(t) {
      return p() ? (t === dt ? ut : mt) : t === dt ? mt : ut;
    }
    static PauseCarousel(t) {
      const e = t.target,
        i = e.getAttribute(Nt),
        s = Ft.getOrCreateInstance(document.querySelector(i));
      e.classList.contains("pause") ? s.pause() : s.cycle();
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  j.on(document, wt, "[data-bs-slide], [data-bs-slide-to]", function (t) {
    ...
    t.preventDefault();
    const i = Ft.getOrCreateInstance(e),
    ...
    j.on(document, wt, $t, Ft.PauseCarousel),
    j.on(window, yt, () => {
      const t = K.find('[data-bs-ride="carousel"]');
      for (const e of t) Ft.getOrCreateInstance(e);
    }),
    b(Ft);
  const Bt = ".bs.collapse",
    qt = `show${Bt}`,
    zt = `shown${Bt}`,
    Ht = `hide${Bt}`,
    Wt = `hidden${Bt}`,
    Rt = `click${Bt}.data-api`,
    Kt = "show",
    Vt = "collapse",
    Qt = "collapsing",
    Ut = `:scope .${Vt} .${Vt}`,
    Yt = '[data-bs-toggle="collapse"]',
    Xt = { parent: null, toggle: !0 },
  ...
  class Jt extends W {
      ...
      this._queueCallback(
        () => {
          (this._isTransitioning = !1),
            ...
            this._element.classList.add(Vt, Kt),
            (this._element.style[e] = ""),
            j.trigger(this._element, zt);
        },
        this._element,
        !0
      ),
    ...
    hide() {
      ...
      (this._element.style[t] = `${
        ...
        _(this._element),
        this._element.classList.add(Qt),
        this._element.classList.remove(Vt, Kt),
        (this._isTransitioning = !0),
        (this._element.style[t] = ""),
        this._queueCallback(
          () => {
    ...
    _initializeChildren() {
      ...
      const t = this._getFirstLevelChildren(Yt);
      for (const e of t) {
    ...
    _getFirstLevelChildren(t) {
      const e = K.find(Ut, this._config.parent);
  ...
  j.on(document, Rt, Yt, function (t) {
    ("A" === t.target.tagName ||
  ...
  const Zt = "dropdown",
    ...
    fe = p() ? "top-start" : "top-end",
    pe = p() ? "bottom-end" : "bottom-start",
    be = p() ? "bottom-start" : "bottom-end",
    ve = p() ? "left-start" : "right-start",
    ye = p() ? "right-start" : "left-start",
    we = {
      autoClose: !0,
  ...
  class Ae extends W {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          K.next(this._element, _e)[0] ||
          K.prev(this._element, _e)[0] ||
          K.findOne(_e, this._parent)),
    ...
    show() {
      ...
      if (!j.trigger(this._element, re, t).defaultPrevented) {
        if (
          (this._createPopper(),
          "ontouchstart" in document.documentElement &&
        ...
        this._element.focus(),
          ...
          this._menu.classList.add(de),
          this._element.classList.add(de),
          j.trigger(this._element, ae, t);
      }
    }
    hide() {
      if (d(this._element) || !this._isShown()) return;
    ...
    _completeHide(t) {
      if (!j.trigger(this._element, ne, t).defaultPrevented) {
        if ("ontouchstart" in document.documentElement)
          for (const t of [].concat(...document.body.children))
            j.off(t, "mouseover", m);
        this._popper && this._popper.destroy(),
          this._menu.classList.remove(de),
          this._element.classList.remove(de),
          this._element.setAttribute("aria-expanded", "false"),
          z.removeDataAttribute(this._menu, "popper"),
          j.trigger(this._element, oe, t);
      }
    }
    _getConfig(t) {
      if (
    ...
    _isShown() {
      return this._menu.classList.contains(de);
    }
    _getPlacement() {
      ...
      return t.classList.contains("dropup") ? (e ? fe : ge) : e ? be : pe;
    }
    _detectNavbar() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      ...
      i.length && w(i, e, t === se, !i.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    static dataApiKeydownHandler(t) {
      const e = /input|textarea/i.test(t.target.tagName),
        i = "Escape" === t.key,
        s = [ie, se].includes(t.key);
      if (!s && !i) return;
      if (e && !i) return;
      t.preventDefault();
      const n = this.matches(ue)
          ? this
          : K.prev(this, ue)[0] ||
            K.next(this, ue)[0] ||
            K.findOne(ue, t.delegateTarget.parentNode),
        o = Ae.getOrCreateInstance(n);
      if (s) return t.stopPropagation(), o.show(), void o._selectMenuItem(t);
      o._isShown() && (t.stopPropagation(), o.hide(), n.focus());
    }
  }
  j.on(document, ce, ue, Ae.dataApiKeydownHandler),
    j.on(document, ce, _e, Ae.dataApiKeydownHandler),
    j.on(document, le, Ae.clearMenus),
    j.on(document, he, Ae.clearMenus),
    j.on(document, le, ue, function (t) {
      t.preventDefault(), Ae.getOrCreateInstance(this).toggle();
    }),
    b(Ae);
  const Ce = "backdrop",
    Te = "show",
  ...
  class $e extends H {
    ...
    hide(t) {
      this._config.isVisible
        ? (this._getElement().classList.remove(Te),
          this._emulateAnimation(() => {
            this.dispose(), v(t);
          }))
        : v(t);
  ...
  const Ne = ".bs.focustrap",
    ...
    Ie = `keydown.tab${Ne}`,
    Pe = "backward",
    De = { autofocus: !0, trapElement: null },
  ...
  class Me extends H {
    ...
    activate() {
      this._isActive ||
        ...
        j.off(document, Ne),
        j.on(document, Oe, (t) => this._handleFocusin(t)),
        j.on(document, Ie, (t) => this._handleKeydown(t)),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), j.off(document, Ne));
    }
    _handleFocusin(t) {
  ...
  const je = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    Fe = ".sticky-top",
    Be = "padding-right",
    qe = "margin-right";
  class ze {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        this._setElementAttributes(this._element, Be, (e) => e + t),
        this._setElementAttributes(je, Be, (e) => e + t),
        this._setElementAttributes(Fe, qe, (e) => e - t);
    }
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        this._resetElementAttributes(this._element, Be),
        this._resetElementAttributes(je, Be),
        this._resetElementAttributes(Fe, qe);
    }
    isOverflowing() {
    ...
    _resetElementAttributes(t, e) {
      this._applyManipulationCallback(t, (t) => {
        ...
        null !== i
          ? (z.removeDataAttribute(t, e), t.style.setProperty(e, i))
  ...
  const He = ".bs.modal",
    ...
    Ue = `resize${He}`,
    Ye = `click.dismiss${He}`,
    Xe = `mousedown.dismiss${He}`,
    Ge = `keydown.dismiss${He}`,
    Je = `click${He}.data-api`,
    Ze = "modal-open",
    ti = "show",
    ei = "modal-static",
  ...
  class ni extends W {
    ...
    show(t) {
      this._isShown ||
        ...
        j.trigger(this._element, Ve, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    hide() {
      this._isShown &&
        !this._isTransitioning &&
        (j.trigger(this._element, We).defaultPrevented ||
          ((this._isShown = !1),
          (this._isTransitioning = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              j.trigger(this._element, Qe, { relatedTarget: t });
          },
          this._dialog,
          this._isAnimated()
        );
    ...
    _addEventListeners() {
      j.on(this._element, Ge, (t) => {
        ...
        j.on(this._element, Xe, (t) => {
          j.one(this._element, Ye, (e) => {
  ...
  j.on(document, Je, '[data-bs-toggle="modal"]', function (t) {
    const e = K.getElementFromSelector(this);
  ...
  class Ei extends W {
    ...
    show(t) {
      this._isShown ||
        j.trigger(this._element, ui, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
        ...
        this._queueCallback(
          () => {
            (this._config.scroll && !this._config.backdrop) ||
              ...
              j.trigger(this._element, mi, { relatedTarget: t });
          },
          this._element,
          !0
        ));
    ...
    hide() {
      this._isShown &&
        (j.trigger(this._element, _i).defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove(li, hi),
                this._element.removeAttribute("aria-modal"),
                this._element.removeAttribute("role"),
    ...
    _addEventListeners() {
      j.on(this._element, vi, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : j.trigger(this._element, gi));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  j.on(document, bi, '[data-bs-toggle="offcanvas"]', function (t) {
    const e = K.getElementFromSelector(this);
    ...
    const i = K.findOne(di);
    i && i !== e && Ei.getInstance(i).hide(),
      Ei.getOrCreateInstance(e).toggle(this);
  }),
    j.on(window, ai, () => {
      for (const t of K.find(di)) Ei.getOrCreateInstance(t).show();
    }),
    j.on(window, pi, () => {
    ...
    V(Ei),
    b(Ei);
  const Ai = ".bs.orangenavbar",
    Ci = ".data-api",
    Ti = `scroll${Ai}${Ci}`,
    Li = `load${Ai}${Ci}`,
    ki = "header.sticky-top";
  class Si extends W {
    static get NAME() {
      return "orangenavbar";
    }
  ...
  j.on(window, Ti, () => {
    for (const t of K.find(ki)) Si.enableMinimizing(t);
  }),
    j.on(window, Li, () => {
      for (const t of K.find(ki)) Si.enableMinimizing(t);
    }),
  ...
  const $i = {
    ...
    Ii = (t, e) => {
      ...
      return e.includes(i)
        ? !Ni.has(i) || Boolean(Oi.test(t.nodeValue))
        ...
        ? (function (t, e, i) {
            ...
            for (const t of n) {
              ...
              const s = [].concat(...t.attributes),
                n = [].concat(e["*"] || [], e[i] || []);
              for (const e of s) Ii(e, n) || t.removeAttribute(e.nodeName);
            }
  ...
  class Qi extends W {
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(qi), zi, this._hideModalHandler),
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(Fi), e
      );
    }
    setContent(t) {
      (this._newContent = t),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(Fi))
      );
    }
    _isShown() {
    ...
    _setListeners() {
      ...
      for (const e of t)
        if ("click" === e)
          ...
          j.on(this._element, t, this._config.selector, (t) => {
            ...
            (e._activeTrigger["focusin" === t.type ? Wi : Hi] = !0), e._enter();
          }),
            j.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger["focusout" === t.type ? Wi : Hi] =
      ...
      (this._hideModalHandler = () => {
        ...
        j.on(this._element.closest(qi), zi, this._hideModalHandler);
    }
    _fixTitle() {
  ...
  const Ui = {
    ...
    Yi = { ...Qi.DefaultType, content: "(null|string|element|function)" };
  class Xi extends Qi {
    static get Default() {
      return Ui;
    }
  ...
  b(Xi);
  const Gi = ".bs.quantityselector",
    Ji = ".data-api",
    Zi = `load${Gi}${Ji}`,
    ts = `change${Gi}${Ji}`,
    es = `click${Gi}${Ji}`,
    is = '[data-bs-step="up"]',
    ss = '[data-bs-step="down"]',
    ns = '[data-bs-step="counter"]',
  ...
  class rs extends W {
    ...
    ValueOnLoad(t) {
      const e = t.querySelector(ns),
        ...
        s = t.querySelector(ss),
        n = e.getAttribute("min"),
        o = e.getAttribute("max"),
        r = Number(e.getAttribute("step"));
      Number(e.value) - r < n && s.setAttribute("disabled", ""),
        Number(e.value) + r > o && i.setAttribute("disabled", "");
    }
    static StepUp(t) {
      const e = t.target.closest(os).querySelector(ns),
        i = e.getAttribute("max"),
        s = Number(e.getAttribute("step")),
        n = Number(e.getAttribute("data-bs-round")),
        o = new Event("change");
      Number(e.value) < i &&
        (e.value = (Number(e.value) + s).toFixed(n).toString()),
        e.dispatchEvent(o);
    }
    static StepDown(t) {
      const e = t.target.closest(os).querySelector(ns),
    ...
    static CheckIfDisabledOnChange(t) {
      const e = t.target.closest(os),
        i = e.querySelector(ns),
        s = e.querySelector(is),
        n = e.querySelector(ss),
        o = i.getAttribute("min"),
        r = i.getAttribute("max"),
        a = Number(i.getAttribute("step"));
      s.removeAttribute("disabled", ""),
        n.removeAttribute("disabled", ""),
        Number(i.value) - a < o && n.setAttribute("disabled", ""),
        Number(i.value) + a > r && s.setAttribute("disabled", "");
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  j.on(document, ts, ns, rs.CheckIfDisabledOnChange),
    j.on(document, es, is, rs.StepUp),
    j.on(document, es, ss, rs.StepDown),
    j.on(window, Zi, () => {
      for (const t of K.find(os)) rs.getOrCreateInstance(t).ValueOnLoad(t);
    }),
    b(rs);
  const as = ".bs.scrollspy",
    ...
    us = "[href]",
    ms = ".nav-link",
    _s = `${ms}, .nav-item > ${ms}, .list-group-item`,
    gs = {
      offset: null,
  ...
  class ps extends W {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (j.off(this._config.target, cs),
        j.on(this._config.target, cs, us, (t) => {
    ...
    _initializeTargetsAndObservables() {
      ...
      const t = K.find(us, this._config.target);
      for (const e of t) {
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        j.trigger(this._element, ls, { relatedTarget: t }));
    }
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        K.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(ds);
      else
        for (const e of K.parents(t, ".nav, .list-group"))
          for (const t of K.prev(e, _s)) t.classList.add(ds);
    }
    _clearActiveClass(t) {
      t.classList.remove(ds);
      const e = K.find(`${us}.${ds}`, t);
  ...
  j.on(window, hs, () => {
    for (const t of K.find('[data-bs-spy="scroll"]')) ps.getOrCreateInstance(t);
  }),
    b(ps);
  const bs = ".bs.tab",
    vs = `hide${bs}`,
    ...
    Fs = `.nav-link${Ms}, .list-group-item${Ms}, [role="tab"]${Ms}, ${js}`,
    Bs = `.${Is}[data-bs-toggle="tab"], .${Is}[data-bs-toggle="pill"], .${Is}[data-bs-toggle="list"]`;
  class qs extends W {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          ...
          j.on(this._element, Cs, (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      const e = this._getActiveElem(),
        i = e ? j.trigger(e, vs, { relatedTarget: t }) : null;
      j.trigger(t, ws, { relatedTarget: e }).defaultPrevented ||
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.setAttribute("aria-selected", !1),
                ...
                j.trigger(t, ys, { relatedTarget: e }))
              : t.classList.remove(Ds);
          },
          t,
          t.classList.contains(Ps)
    ...
    _keydown(t) {
      if (![Ls, ks, Ss, $s, Ns, Os].includes(t.key)) return;
      t.stopPropagation(), t.preventDefault();
      const e = this._getChildren().filter((t) => !d(t));
      let i;
      if ([Ns, Os].includes(t.key)) i = e[t.key === Ns ? 0 : e.length - 1];
      else {
        const s = [ks, $s].includes(t.key);
        i = w(e, t.target, s, !0);
      }
      i && (i.focus({ preventScroll: !0 }), qs.getOrCreateInstance(i).show());
    }
    _getChildren() {
      return K.find(Fs, this._parent);
    }
    _getActiveElem() {
    ...
    _toggleDropDown(t, e) {
      ...
      s(xs, Is), s(".dropdown-menu", Ds), i.setAttribute("aria-expanded", e);
    }
    ...
    _getInnerElement(t) {
      return t.matches(Fs) ? t : K.findOne(Fs, t);
    }
    _getOuterElement(t) {
  ...
  j.on(document, As, js, function (t) {
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
      d(this) || qs.getOrCreateInstance(this).show();
  }),
    j.on(window, Ts, () => {
      for (const t of K.find(Bs)) qs.getOrCreateInstance(t);
    }),
    b(qs);
  const zs = ".bs.toast",
    Hs = `mouseover${zs}`,
  ...
  class en extends W {
    ...
    show() {
      j.trigger(this._element, Us).defaultPrevented ||
        (this._clearTimeout(),
        this._config.animation && this._element.classList.add("fade"),
        this._element.classList.remove(Xs),
        _(this._element),
        this._element.classList.add(Gs, Js),
        this._queueCallback(
          () => {
            this._element.classList.remove(Js),
              j.trigger(this._element, Ys),
    ...
    hide() {
      this.isShown() &&
        (j.trigger(this._element, Vs).defaultPrevented ||
          (this._element.classList.add(Js),
          this._queueCallback(
            () => {
              this._element.classList.add(Xs),
                this._element.classList.remove(Js, Gs),
                j.trigger(this._element, Qs);
            },
            this._element,
            this._config.animation
          )));
    ...
    dispose() {
      this._clearTimeout(),
        this.isShown() && this._element.classList.remove(Gs),
        super.dispose();
    }
    isShown() {
    ...
    _setListeners() {
      j.on(this._element, Hs, (t) => this._onInteraction(t, !0)),
        j.on(this._element, Ws, (t) => this._onInteraction(t, !1)),
        j.on(this._element, Rs, (t) => this._onInteraction(t, !0)),
        ...
        document.addEventListener(
          ...
          function (i) {
            i.metaKey ||
              i.altKey ||
              i.ctrlKey ||
              (o(t.activeElement) && r(t.activeElement), (e = !0));
          },
          !0
        ),
          ...
          t.addEventListener(
            ...
            function (t) {
              ...
              o(t.target) &&
                (e ||
                  ((s = (i = t.target).type),
                  ("INPUT" === (a = i.tagName) && n[s] && !i.readOnly) ||
