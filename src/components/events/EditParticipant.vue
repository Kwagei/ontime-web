...
const onSubmit = async () => {
    ...
    await $.ajax({
        url: `${API_URL}event_participants/${props.participant?.id}`,
        type: "PUT",
        data: participant,
        headers: {
...
onMounted(() => {
    ...
    // initialize data
    first_name.value = props.participant.first_name;
    last_name.value = props.participant.last_name;
    msisdn.value = props.participant.msisdn;
    email.value = props.participant.email;
    address.value = props.participant.address;
    session.value = props.participant.session;
    gender.value = props.participant.gender.toLowerCase();
    occupation.value = props.participant.occupation;
});
</script>
